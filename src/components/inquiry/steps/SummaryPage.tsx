...
import type { InquiryFormData } from "@/utils/formUtils";
import { Button } from "@/components/ui/button";
import { ArrowLeft, Send, Loader2, Download, RotateCcw } from "lucide-react"; // Added Download, RotateCcw
import { useToast } from "@/hooks/use-toast"; // Using the correct shadcn toast hook

type SummaryPageProps = {
  formData: InquiryFormData; // This refers to your type from formUtils
  onPrev: () => void;
